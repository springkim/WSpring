...
curlw -L "https://github.com/springkim/WSpring/releases/download/cuda/cuda_9.0.176_win10.exe" -o "%TEMP%\cuda9.0.exe"
curlw -L "https://github.com/springkim/WSpring/releases/download/cuda/cuda_9.0.176.1_windows.exe" -o "%TEMP%\cuda9.0_1.exe"
curlw -L "https://github.com/springkim/WSpring/releases/download/cuda/cuda_9.0.176.2_windows.exe" -o "%TEMP%\cuda9.0_2.exe"
