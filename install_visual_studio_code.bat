::
::  install_visual_studio_code.bat
::  WSpring
::
::  Created by Woocheol on 2019. 02. 12...
...
set INSTALL_NAME=VSCodeUserSetup-x64-latest.exe
curlw -L "https://aka.ms/win32-x64-user-stable" -o "%INSTALL_NAME%"
echo Installing...
start /wait %INSTALL_NAME% /VERYSILENT
echo Finish!!
pause
exit /b
